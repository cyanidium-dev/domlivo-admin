/**
 * COPIED from bot/src/scrubContacts.ts — do not edit here. There is no shared
 * package across the three repos; cms/lib/studioAi/slug.ts is duplicated from
 * the bot the same way. The test beside this file pins both to the same cases,
 * so a drift in either repo fails a build.
 *
 * scrubEditorial is not copied: cms needs scrubContacts alone.
 */
/**
