...
describe('decideTranslationSets', () => {
  ...
  const translated = new Map([
    ['title', {en: 'Center!', uk: 'Центр', ru: 'Центр', sq: 'Qendër', it: 'Centro', pl: 'Centrum', de: 'Zentrum'}],
    ['description', {en: 'Long text.', uk: 'Довгий текст.', ru: 'Длинный текст.', sq: 'Tekst i gjatë.', it: 'X', pl: 'Długi tekst.', de: 'Langer Text.'}],
  ])
...
describe('decideParseSets', () => {
  const resp: ParseResponse = {
    parsed: {
      ...
      editorial: {
        title: {en: 'T-en', uk: 'T-uk', ru: 'T-ru', sq: 'T-sq', it: 'T-it', pl: 'T-pl', de: 'T-de'},
        shortDescription: {en: 's', uk: 's', ru: 's', sq: 's', it: 's', pl: 's', de: 's'},
        description: {en: 'd', uk: 'd', ru: 'd', sq: 'd', it: 'd', pl: 'd', de: 'd'},
      },
      parserNotes: '',
    },
...
describe('rooms', () => {
  const withRooms: ParseResponse = {
    parsed: {
      ...
      editorial: {
        title: {en: 'T', uk: 'T', ru: 'T', sq: 'T', it: 'T', pl: 'T', de: 'T'},
        shortDescription: {en: 's', uk: 's', ru: 's', sq: 's', it: 's', pl: 's', de: 's'},
        description: {en: 'd', uk: 'd', ru: 'd', sq: 'd', it: 'd', pl: 'd', de: 'd'},
      },
      parserNotes: '',
