...
export const ZONE_EDITORIAL_COPY: Record<string, EditorialCopy> = {
  ...
  'golem-durres': {
    en: "Golem is the second and third line behind the beach south of Durrës, asking €1,100–1,500/m² and rising 8–15% year on year — cheaper than the first line, and cheaper than Qerret further down the same sand. The state reference price for the zone is 56,500 lek/m², which is the figure your notary and tax bill are calculated from. The zone's standing problem is sewerage discharging onto the beach. It has not stopped prices, but it is the one thing worth checking on the ground, in season, before you buy here to rent out.",
    ru: 'Голем — вторая и третья линия за пляжем к югу от Дурреса: €1 100–1 500/м², рост 8–15% год к году. Дешевле первой линии и дешевле Черрета дальше по той же полосе. Государственная справочная цена зоны — 56 500 лек/м², и именно от неё считаются нотариальные и налоговые расходы. Постоянная проблема зоны — сток канализации на пляж. На цены это пока не повлияло, но это единственное, что стоит проверить на месте и в сезон, если покупаете под аренду.',
  },
