...
export const CITY_DESCRIPTION_TRANSLATIONS: Translations = {
  ...
  himare: {
    uk: 'Хімара оцінюється як єдиний ринок: перша лінія з видом сягає €3 500/м² і падає приблизно до €2 200 через дві-три вулиці вглиб. Медіана по місту — €2 701/м² за діапазону €1 600–3 200. Мікрозони тут окремо не оцінюються, бо вибірки справді замалі — це властивість ринку, а не прогалина в даних. Державна довідкова ставка — 58 000 лек/м²; проєкт карти 2026 року підняв би її на 141%, до 140 000, але його не затверджено.',
    sq: 'Himara çmohet si një treg i vetëm: vija e parë me pamje arrin €3.500/m² dhe bie në rreth €2.200 dy ose tre rrugë prapa. Mesatarja e qytetit është €2.701/m² brenda një brezi €1.600–3.200. Mikrozonat nuk çmohen veçmas këtu sepse kampionët janë vërtet shumë të hollë — një veti e këtij tregu, jo një mangësi në të dhëna. Çmimi shtetëror i referencës është 58.000 lekë/m²; një draft i hartës së 2026-s do ta rriste me 141%, në 140.000, por drafti nuk është miratuar.',
    it: 'Himara si valuta come un mercato unico: la prima linea con vista arriva a €3.500/m² e scende a circa €2.200 due o tre strade più indietro. La mediana cittadina è €2.701/m² su una fascia €1.600–3.200. Le microzone non si prezzano separatamente qui perché i campioni sono davvero troppo esigui: è una caratteristica di questo mercato, non una lacuna nei dati. Il prezzo di riferimento statale è di 58.000 lek/m²; una bozza di mappa del 2026 lo porterebbe a 140.000 (+141%), ma non è stata approvata.',
    pl: 'Himarë wycenia się jako jeden rynek: pierwsza linia z widokiem sięga €3500/m² i spada do około €2200 dwie lub trzy ulice w głąb. Mediana dla miasta to €2701/m² w przedziale €1600–3200. Mikrostrefy nie są tu wyceniane osobno, bo próby są naprawdę zbyt małe — to cecha tego rynku, a nie luka w danych. Państwowa cena referencyjna wynosi 58 000 lek/m²; projekt mapy z 2026 roku podniósłby ją o 141%, do 140 000, ale nie został zatwierdzony.',
  },
