  ...
  'city-center-durres': {
    ...
    items: [
      ...
      },
      {
        ...
        a: {
          en: 'The official reference prices. The schedule in force from 1 January 2026 tripled the port zone figure to 200,000 lek per square metre, and notary and tax costs are calculated from that schedule rather than from the price you actually pay. Ask your notary for the reference value of the exact address before you agree the final price.',
          sq: 'Çmimet zyrtare të referencës. Tabela në fuqi nga 1 janari 2026 e trefishoi vlerën e zonës së portit në 200.000 lekë për metër katror, dhe kostot e noterit dhe taksat llogariten sipas kësaj tabele, jo sipas çmimit që paguani në fakt. Kërkojini noterit vlerën e referencës për adresën e saktë para se të bini dakord për çmimin përfundimtar.',
          ru: 'Официальные справочные цены. Таблица, действующая с 1 января 2026 года, утроила показатель портовой зоны до 200 000 леков за квадратный метр, а нотариальные расходы и налоги считаются по этой таблице, а не по цене, которую вы фактически платите. Попросите нотариуса назвать справочную стоимость конкретного адреса до того, как согласуете окончательную цену.',
          uk: 'Офіційні довідкові ціни. Таблиця, чинна з 1 січня 2026 року, потроїла показник портової зони до 200 000 леків за квадратний метр, а нотаріальні витрати й податки рахуються за цією таблицею, а не за ціною, яку ви фактично платите. Попросіть нотаріуса назвати довідкову вартість конкретної адреси до того, як погодите остаточну ціну.',
          it: "I prezzi di riferimento ufficiali. La tabella in vigore dal 1° gennaio 2026 ha triplicato il valore della zona del porto a 200.000 lek al metro quadro, e i costi notarili e le imposte si calcolano su quella tabella, non sul prezzo che paghi davvero. Chiedi al notaio il valore di riferimento dell'indirizzo esatto prima di concordare il prezzo finale.",
          pl: 'Oficjalne ceny referencyjne. Tabela obowiązująca od 1 stycznia 2026 roku potroiła wartość strefy portowej do 200 000 leków za metr kwadratowy, a koszty notarialne i podatki liczy się według tej tabeli, a nie według ceny, którą faktycznie płacisz. Zapytaj notariusza o wartość referencyjną konkretnego adresu, zanim uzgodnisz ostateczną cenę.',
        },
      },
    ],
  },
