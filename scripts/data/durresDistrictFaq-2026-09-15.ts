    ...
    items: [
      {
        ...
        a: {
          en: 'Golem asks about €1,100–1,500 per square metre in 2026, rising 8–15% year on year — cheaper than the first line and cheaper than Qerret further down the same beach. The first line itself prices separately, at roughly €2,000–2,500/m². The state reference price for the zone is 56,500 lek/m².',
          sq: 'Golemi kërkon rreth 1.100–1.500 € për metër katror në vitin 2026, me rritje 8–15% në vit — më lirë se vija e parë dhe më lirë se Qerreti më poshtë në të njëjtin plazh. Vetë vija e parë ka çmim më vete, rreth 2.000–2.500 €/m². Çmimi shtetëror i referencës për zonën është 56.500 lekë/m².',
          ru: 'Голем просит около €1 100–1 500 за квадратный метр в 2026 году при росте на 8–15% в год — дешевле первой линии и дешевле Керрета дальше по тому же пляжу. Сама первая линия оценивается отдельно, примерно в €2 000–2 500/м². Государственная справочная цена для зоны — 56 500 лек/м².',
          uk: 'Голем просить близько €1 100–1 500 за квадратний метр у 2026 році при зростанні на 8–15% на рік — дешевше за першу лінію і дешевше за Керрет далі тим самим пляжем. Сама перша лінія оцінюється окремо, приблизно в €2 000–2 500/м². Державна довідкова ціна для зони — 56 500 лек/м².',
          it: 'Golem chiede circa 1.100–1.500 € al metro quadro nel 2026, in crescita dell’8–15% annuo — meno della prima fila e meno di Qerret, più avanti sulla stessa spiaggia. La prima fila ha prezzi a parte, intorno a 2.000–2.500 €/m². Il prezzo di riferimento statale per la zona è di 56.500 lek/m².',
          pl: 'Golem to w 2026 roku około 1100–1500 € za metr kwadratowy przy wzroście o 8–15% rocznie — taniej niż pierwsza linia i taniej niż Qerret dalej na tej samej plaży. Sama pierwsza linia ma osobne ceny, około 2000–2500 €/m². Państwowa cena referencyjna dla strefy wynosi 56 500 lek/m².',
        },
      },
      {
        q: {
      ...
      },
      {
        ...
        a: {
          en: "The beach itself. Golem's standing problem is sewage discharging onto the sand. It has not stopped prices rising, but it is the one thing worth checking on the ground, in season, before you buy to rent out. Also confirm the reference price of 56,500 lek/m², because notary and tax costs are calculated from it.",
          sq: 'Vetë plazhin. Problemi i vazhdueshëm i Golemit janë ujërat e zeza që shkarkohen në rërë. Kjo nuk i ka ndalur çmimet, por është e vetmja gjë që ia vlen ta kontrolloni në vend, gjatë sezonit, para se të blini për ta dhënë me qira. Konfirmoni edhe çmimin e referencës prej 56.500 lekë/m², sepse kostot e noterit dhe taksat llogariten mbi të.',
          ru: 'Сам пляж. Хроническая проблема Голема — сброс канализации на песок. Рост цен это не остановило, но это единственное, что стоит проверить на месте и в сезон, прежде чем покупать под сдачу. Уточните также справочную цену 56 500 лек/м²: от неё считаются нотариальные расходы и налоги.',
          uk: 'Сам пляж. Хронічна проблема Голема — скидання каналізації на пісок. Зростання цін це не зупинило, але це єдине, що варто перевірити на місці й у сезон, перш ніж купувати під оренду. Уточніть також довідкову ціну 56 500 лек/м²: від неї рахуються нотаріальні витрати й податки.',
          it: 'La spiaggia stessa. Il problema cronico di Golem sono gli scarichi fognari che finiscono sulla sabbia. Non ha fermato la crescita dei prezzi, ma è l’unica cosa da verificare sul posto, in stagione, prima di comprare per affittare. Conferma anche il prezzo di riferimento di 56.500 lek/m², perché costi notarili e imposte si calcolano su quello.',
          pl: 'Samą plażę. Stałym problemem Golem jest zrzut ścieków na piasek. Nie zatrzymało to wzrostu cen, ale to jedyna rzecz, którą warto sprawdzić na miejscu, w sezonie, zanim kupisz pod najem. Potwierdź też cenę referencyjną 56 500 lek/m², bo od niej liczy się koszty notarialne i podatki.',
        },
      },
    ],
  },
