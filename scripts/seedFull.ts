...
async function main() {
  ...
  await client.createOrReplace({
    ...
    footerApp: {enabled: false},
    copyrightText: L('© 2025 Domlivo', '© 2025 Domlivo', '© 2025 Domlivo', '© 2025 Domlivo'),
    similarPropertiesCount: 2,
    maxPremiumPromotions: 6,
    maxTopPromotions: 6,
    maxSalePromotions: 6,
  ...
  const propertiesData = [
    ...
    {slug: 'office-tirana', cityId: 'city-tirana', districtId: 'district-pazari-i-ri', typeSlug: 'office', agentIdx: 3, status: 'rent' as const, price: 1200, bed: 0, bath: 2, area: 85, tags: ['city-center', 'new-development'], amenities: ['elevator', 'parking', 'ac'], title: L('Zyra për qira', 'Office for Rent', 'Офис в аренду', 'Офіс в оренду'), shortDesc: L('Zyra moderne', 'Modern office', 'Современный офис', 'Сучасний офіс'), promoted: false},
    {slug: 'apartment-sarande-center', cityId: 'city-sarande', districtId: 'district-sarande-center', typeSlug: 'apartment', agentIdx: 0, status: 'sale' as const, price: 85000, bed: 2, bath: 1, area: 58, tags: ['city-center', 'walkable-location'], amenities: ['balcony', 'ac'], title: L('Apartament në Sarandë', 'Apartment in Sarande', 'Квартира в Саранде', 'Квартира в Саранді'), shortDesc: L('2 dhoma qendër', '2-bed center', '2-комн. центр', '2-кімн. центр'), promoted: false},
    {slug: 'villa-uji-i-ftohte', cityId: 'city-vlore', districtId: 'district-uji-i-ftohte', typeSlug: 'villa', agentIdx: 2, status: 'sale' as const, price: 320000, bed: 3, bath: 3, area: 180, tags: ['near-beach', 'premium-area'], amenities: ['pool', 'terrace', 'sea-view', 'parking'], title: L('Vilë afër plazhit', 'Villa near Beach', 'Вилла у пляжа', 'Вілла біля пляжу'), shortDesc: L('3 dhoma me pishinë', '3-bed with pool', '3 спальни с бассейном', '3 спальні з басейном'), promoted: true, promotionType: 'top' as const},
    {slug: 'land-shkoder', cityId: 'city-shkoder', districtId: 'district-parruce', typeSlug: 'land', agentIdx: 4, status: 'sale' as const, price: 45000, bed: 0, bath: 0, area: 500, tags: ['investment-opportunity', 'quiet-area'], amenities: [], title: L('Tokë për zhvillim', 'Land for Development', 'Участок под застройку', 'Ділянка під забудову'), shortDesc: L('500m²', '500m²', '500м²', '500м²'), promoted: false},
    {slug: 'apartment-himare', cityId: 'city-himare', districtId: 'district-livadhi', typeSlug: 'apartment', agentIdx: 1, status: 'short-term' as const, price: 750, bed: 2, bath: 2, area: 72, tags: ['near-beach'], amenities: ['balcony', 'ac', 'furnished'], title: L('Apartament me pamje', 'Sea View Apartment in Livadhi', 'Квартира с видом в Ливади', 'Квартира з видом в Ліваді'), shortDesc: L('2 dhoma në Livadh', '2-bed in Livadhi', '2-комн. в Ливади', '2-кімн. в Ліваді'), promoted: true, promotionType: 'top' as const},
    {slug: 'house-komuna-parisit-large', cityId: 'city-tirana', districtId: 'district-komuna-parisit', typeSlug: 'house', agentIdx: 3, status: 'sale' as const, price: 220000, bed: 4, bath: 3, area: 195, tags: ['quiet-area', 'family-friendly'], amenities: ['garden', 'terrace', 'parking'], title: L('Shtëpi familjare me pamje', 'Family House with Garden in Komuna e Parisit', 'Дом с садом в Коммуна Паризит', 'Будинок з садом у Комуна Паризит'), shortDesc: L('4 dhoma me kopsht', '4-bed with garden', '4 спальни с садом', '4 спальні з садом'), promoted: false},
    {slug: 'apartment-shkozet', cityId: 'city-durres', districtId: 'district-shkozet', typeSlug: 'apartment', agentIdx: 2, status: 'sale' as const, price: 115000, bed: 2, bath: 2, area: 78, tags: ['new-development', 'investment-opportunity'], amenities: ['elevator', 'balcony', 'parking', 'ac'], title: L('Apartament i ri në Shkozet', 'New Apartment in Shkozet', 'Новая квартира в Шкозете', 'Нова квартира в Шкозеті'), shortDesc: L('2 dhoma Shkozet', '2-bed Shkozet', '2-комн. Шкозет', '2-кімн. Шкозет'), promoted: false},
    {slug: 'villa-vlore-center', cityId: 'city-vlore', districtId: 'district-vlore-center', typeSlug: 'villa', agentIdx: 4, status: 'sale' as const, price: 380000, bed: 4, bath: 4, area: 250, tags: ['near-beach', 'premium-area'], amenities: ['pool', 'garden', 'terrace', 'parking', 'ac'], title: L('Vilë luksoze në Vlorë', 'Luxury Villa in Vlore', 'Люкс вилла в Влёре', 'Люкс вілла у Вльорі'), shortDesc: L('4 dhoma me pishinë', '4-bed luxury', '4 спальни люкс', '4 спальні люкс'), promoted: true, promotionType: 'top' as const},
    {slug: 'apartment-shkoder', cityId: 'city-shkoder', districtId: 'district-gjuhadol', typeSlug: 'apartment', agentIdx: 0, status: 'sale' as const, price: 52000, bed: 2, bath: 1, area: 62, tags: ['city-center', 'investment-opportunity'], amenities: ['balcony', 'parking'], title: L('Apartament në Shkodër', 'Apartment in Shkoder', 'Квартира в Шкодере', 'Квартира в Шкодері'), shortDesc: L('2 dhoma Gjuhadol', '2-bed Gjuhadol', '2-комн. Гьюхадол', '2-кімн. Гьюхадол'), promoted: false},
    {slug: 'apartment-kodra-sarande', cityId: 'city-sarande', districtId: 'district-kodra', typeSlug: 'apartment', agentIdx: 3, status: 'short-term' as const, price: 550, bed: 1, bath: 1, area: 48, tags: ['near-beach', 'walkable-location'], amenities: ['sea-view', 'ac', 'furnished'], title: L('Studio me pamje në Kodër', 'Studio with Views in Kodra', 'Студия с видом в Кодра', 'Студія з видом у Кодра'), shortDesc: L('Pamje panoramike', 'Panoramic views', 'Панорамный вид', 'Панорамний вид'), promoted: false},
  ]
  ...
  for (const p of propertiesData) {
    ...
    await client.createOrReplace({
      ...
      price: p.price,
      promoted: p.promoted,
      ...(p.promoted && 'promotionType' in p && p.promotionType
        ? {promotionType: p.promotionType}
        : {}),
      // Demo only: mirror promoted into investment for seed data (not required by schema).
      investment: p.promoted,
  ...
  const homeSections = addKeysToArrayItems([
    ...
    },
    {
      ...
      images: [imgRef(invImg1), imgRef(invImg2)],
    },
    {
      _type: 'marketingContentSection',
      enabled: true,
